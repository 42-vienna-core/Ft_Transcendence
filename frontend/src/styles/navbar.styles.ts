...
export const NavStyles = {
    search: {
        div: "flex items-center gap-2 bg-zinc-900/80 border border-zinc-700 rounded-full px-2 py-2 focus-within:border-zinc-500 focus-within:ring-2 focus-within:ring-zinc-500/20 transition-all duration-200 max-sm:hidden ",
    ...
    btnSecondary: "btn  mr-1 bg-bg-card text-text-bright border-border-strong hover:bg-bg-elevated hover:border-text-muted",
    mobileActions: "hidden max-sm:flex max-sm:items-center",
    mobileIconBtn: "flex items-center justify-center w-10 h-10 rounded-full bg-zinc-900 border border-zinc-700 text-zinc-400 hover:text-zinc-200 hover:bg-zinc-800 transition-all duration-150 cursor-pointer",
    mobileMenuDropdown: "hidden max-sm:block max-sm:absolute max-sm:top-full max-sm:left-0 max-sm:right-0 max-sm:px-4 max-sm:py-4 max-sm:bg-black/95 max-sm:backdrop-blur-xl max-sm:border-b max-sm:border-zinc-800",
    mobileNavLinks: "flex flex-col gap-3",
    mobileSearchWrap: "w-full ",
    mobileDivider: "h-px bg-zinc-900 my-1 ",
    mobileAvatarWrap: "flex items-center justify-center py-2",
    mobileAuthWrap: "flex flex-col gap-2",
    mobileAuthBtn: "w-full text-center justify-center",
}